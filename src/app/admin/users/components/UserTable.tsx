                  ...
                  <div className="space-y-8">
                    ...
                    {editUser?.role === 'TEACHER' && (
                      <>
                        ...
                        <div className="space-y-4">
                          <h3 className="text-lg font-semibold text-foreground border-b border-border/30 pb-2">Configuración de API</h3>
                          <div className="p-4 bg-background/30 rounded-lg border border-border/20">
                            <div className="flex items-center space-x-3">
                              <Switch
                                ...
                                disabled={saving}
                              />
                              <Label htmlFor="use-global-api-key" className="font-medium">Permitir API Key personal</Label>
                            </div>
